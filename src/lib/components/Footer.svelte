  ...
  <div class="max-w-7xl mx-auto px-6 mb-32 relative z-10">
    <div class="flex flex-col items-center text-center">
      ...
      <div class="mb-12 relative w-24 h-24 flex items-center justify-center">
        ...
        <!-- Conduct Logo -->
        <svg width="64" height="64" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="text-white">
          <path
            fill-rule="evenodd"
            clip-rule="evenodd"
  ...
  <div class="max-w-7xl mx-auto px-6 relative z-10">
    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-12 mb-32 text-sm">
      <div class="space-y-4">
        ...
        <ul class="space-y-3">
          <li><a href="#" class="hover:text-gray-300">Code Intelligence</a></li>
          <li><a href="#" class="hover:text-gray-300">Dependency Mapping</a></li>
          <li><a href="#" class="hover:text-gray-300">Migration Acceleration</a></li>
      ...
      <div class="space-y-4">
        ...
        <ul class="space-y-3">
          <li><a href="#" class="hover:text-gray-300">S/4HANA Migration</a></li>
          <li><a href="#" class="hover:text-gray-300">System Documentation</a></li>
          <li><a href="#" class="hover:text-gray-300">Custom Code Analysis</a></li>
        </ul>
      </div>
      <div class="space-y-4">
        <h4 class="text-gray-500 font-medium">Resources</h4>
        <ul class="space-y-3">
          <li><a href="#" class="hover:text-gray-300">Customer Stories</a></li>
      ...
      <div class="space-y-4">
        ...
        <ul class="space-y-3">
          ...
          <li><a href="#" class="hover:text-gray-300">ISO 27001</a></li>
          <li><a href="#" class="hover:text-gray-300">GDPR</a></li>
        </ul>
      </div>
    </div>
    ...
    <!-- Big Logo -->
    <div class="mb-12">
      <h1 class="text-[12vw] leading-none font-bold tracking-tighter text-white opacity-90 select-none">Conduct</h1>
    </div>
    ...
    <div class="flex flex-col md:flex-row justify-between items-center gap-6 text-xs text-gray-500 border-t border-white/10 pt-8">
      ...
      <div>
        © 2025 Conduct. Built and backed by the best in enterprise software.
      </div>
    </div>
  </div>
</footer>
